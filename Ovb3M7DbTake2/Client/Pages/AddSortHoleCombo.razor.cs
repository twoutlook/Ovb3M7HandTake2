...
{
    public partial class AddSortHoleCombo
    {
        [Inject]
        ...
        {
            sortHoleCombo = new Ovb3M7Db.Server.Models.AppDb.SortHoleCombo();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                var result = await AppDbService.CreateSortHoleCombo(sortHoleCombo);
