...
namespace Ovb3M7Db.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<Ovb3M7Db.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<Ovb3M7Db.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(Ovb3M7Db.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(Ovb3M7Db.Server.Models.ApplicationUser user)
        {
            try
            {
